...
class TestIndividualNWDAFMLModelProvisionSubscriptionDocumentController(BaseTestCase):
    """IndividualNWDAFMLModelProvisionSubscriptionDocumentController integration test stubs"""

    def test_delete_nwdafml_model_provision_subcription(self):
        """Test case for delete_nwdafml_model_provision_subcription
        ...
        response = self.client.open(
            '/nnwdaf-mlmodelprovision/v1/subscriptions/{subscription_id}'.format(subscription_id='subscription_id_example'),
            method='DELETE',
            headers=headers)
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))

    def test_update_nwdafml_model_provision_subcription(self):
        """Test case for update_nwdafml_model_provision_subcription
