This source code is for the implementation of Network Data Analytics Function (NWDAF) with an analytics service and a machine learning provision service. NWDAF is one of the 5G core network functions that collects network data and provides analytics results to toher network functions, application functions, and operation administration maintenance. We referred to the 3GPP TS23.288 and TS29.520 documents for the implementation of NWDAF. We implemented our NWDAF based on the opens-source project "free5GC" to consider the overall 5G environment (the description of free5GC is as follows).
